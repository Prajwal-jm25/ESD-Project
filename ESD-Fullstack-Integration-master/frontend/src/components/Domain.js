...
const Domain = ({ domain, modifyDomain}) => {
  ...
  return (
    ...
    <tr>
      ...
      <td>
        ...
        <button class="btn btn-outline-info mr-1 btn-space" data-toggle="modal" data-target="#form2" style={{marginRight:"5px"}}  onClick={() => {setIsOpen(true);}}>
          View Students
        </button>
        {isOpen && <Students domain={domain} setIsOpen={setIsOpen}></Students>}
        <button class="btn btn-outline-warning" style={{marginLeft:"100px"}} data-toggle="modal" data-target="#form1" onClick={() => {setIsModOpen(true);}}>
          Modify Details
        </button>
